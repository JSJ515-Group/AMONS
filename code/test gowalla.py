...
user_friend_set, friend_user_set,set_count = np.load(dataset_base_path + '/datanpy/user_friend_set.npy', allow_pickle=True)
...
for epoch in range(start_i_test, end_i_test, setp):
    ...
    str_print_evl = "epoch:" + str(epoch) + '\t time:' + str(round(elapsed_time, 2)) + "\t ---test---" + "\t hit:" + str(
